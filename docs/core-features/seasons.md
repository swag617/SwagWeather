...
The season check runs every 20 real seconds (a fixed internal cadence, not configurable) — more than sufficient responsiveness for something this slow-moving.
